...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_10 = QtGui.QGridLayout(self.comm_tab)
        self.gridLayout_10.setObjectName("gridLayout_10")
        self.command_edit = QtGui.QLineEdit(self.comm_tab)
        self.command_edit.setObjectName("command_edit")
        self.gridLayout_10.addWidget(self.command_edit, 2, 0, 1, 1)
        self.send_button = QtGui.QPushButton(self.comm_tab)
        self.send_button.setObjectName("send_button")
        self.gridLayout_10.addWidget(self.send_button, 2, 1, 1, 1)
        self.comm_text_edit = QtGui.QTextEdit(self.comm_tab)
        self.comm_text_edit.setObjectName("comm_text_edit")
        self.gridLayout_10.addWidget(self.comm_text_edit, 0, 0, 1, 2)
